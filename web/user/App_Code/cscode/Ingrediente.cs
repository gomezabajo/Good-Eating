...
public class Ingrediente
{
            ...
            try
            {
                ...
                if (Common.ActiveConnection != null)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        ing.Id_plato = Escape.getInt(dt.Rows[i][0]);
    ...
    public static Ingrediente getByPlato(int id_plato)
    {
        ...
        try
        {
            ...
            if (Common.ActiveConnection != null)
            {
                ...
                {
                    ing = new Ingrediente();
                    ing.Id_plato = Escape.getInt(dt.Rows[0][0]);
    ...
    public bool Equals(Ingrediente other)
    {
        ...
        {
            return this.Id_plato == other.Id_plato;
        }
        else
        {
            if (Escape.IsNull(this) && Escape.IsNull(other))
    ...
    public int CompareTo(Ingrediente other)
    {
        if (!Escape.IsNull(this) && !Escape.IsNull(other))
        {
            return this.Id_plato.CompareTo(other.Id_plato);
        }
        else
        {
            if (Escape.IsNull(this) && Escape.IsNull(other))
